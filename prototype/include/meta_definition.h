...
typedef struct ECSchema {
  ...
  ECSchema(bool partial_decoding, EncodeType encodetype,
           PlacementType placementtype, int k_datablock, int real_l_localgroup,
           int g_m_globalparityblock, int b_datapergoup, int small_file_upper,
           int blob_size_upper)
      : partial_decoding(partial_decoding), encodetype(encodetype),
        placementtype(placementtype), k_datablock(k_datablock),
        real_l_localgroup(real_l_localgroup),
        g_m_globalparityblock(g_m_globalparityblock),
        b_datapergoup(b_datapergoup), small_file_upper(small_file_upper),
        blob_size_upper(blob_size_upper) {}
...
typedef struct ShardidxRange {
  ...
  ShardidxRange(int idx, int offset, int length)
      : shardidx(idx), offset_in_shard(offset), range_length(length) {}
};
} // namespace OppoProject
